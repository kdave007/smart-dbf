...
class Simple:
    def __init__(self, data_source: str, encryption_password: str, mapping_file_path: str = None, dll_path: str = None, filters_file_path: str = None):
        """
    ...
    def read_dbf_table(self, table_name: str, limit: Optional[int] = None, filters: Optional[List[Dict[str, Any]]] = None) -> List[Dict[str, Any]]:
        ...
        """
        reader = DBFReader(self.data_source, self.encryption_password)
